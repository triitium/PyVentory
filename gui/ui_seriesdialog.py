...
################################################################################
## Form generated from reading UI file 'seriesdialog.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.setStandardButtons(QDialogButtonBox.Apply|QDialogButtonBox.Ok|QDialogButtonBox.Reset)
